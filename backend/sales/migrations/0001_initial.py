    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_percentage', models.DecimalField(decimal_places=2, default=0.0, help_text='Additional discount percentage added to shop margin', max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('cash_collected', models.BooleanField(default=False, help_text='Whether the owner has physically collected this cash from the salesman')),
                ('cash_collected_date', models.DateTimeField(blank=True, help_text='When the owner collected the cash from salesman', null=True)),
                ('cash_collected_by', models.ForeignKey(blank=True, help_text='Owner who collected the cash', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invoice_cash_collections', to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cash_collected', models.BooleanField(default=False, help_text='Whether the owner has physically collected this cash from the salesman')),
                ('cash_collected_date', models.DateTimeField(blank=True, help_text='When the owner collected the cash from salesman', null=True)),
                ('cash_collected_by', models.ForeignKey(blank=True, help_text='Owner who collected the cash', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cash_collections', to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
